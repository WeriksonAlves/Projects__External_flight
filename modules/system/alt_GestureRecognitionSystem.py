...
class GestureRecognitionSystem2:
    ...
    def _process_frame(self) -> None:
        """
        Processes each frame during the system's run loop.
        Handles quit requests, frame processing for gesture recognition,
        and stops when necessary based on dataset mode or user input.
        """
